...
(window.PROBLEMS_REGISTRY = window.PROBLEMS_REGISTRY || []).push({
  ...
  explanation: {
    ...
    complexity: { time: '多変数微積分，確率統計（期待値・共分散）', space: 'ヘッセ行列の対角成分 $\\partial^2 L/\\partial\\beta_1^2 = \\lambda_1\\alpha^2 \\gg \\lambda_2\\alpha^2 = \\partial^2 L/\\partial\\beta_2^2$ を示す計算' },
